...
def fill_with_data():
    ...
    #                      condition="Brand New")
    # db.add_auction_to_db(creatorID=user_1.get('ID'),
    #                      name="Journey's 1.5 minute Auction",
    #                      desc="going, going, gone.",
    #                      image_name="fakeimage.jpg",
    ...
    #                      condition="Brand New")
    # db.add_auction_to_db(creatorID=user_1.get('ID'),
    #                      name="Journey's 2 minute Auction",
    #                      desc="going, going, gone.",
    #                      image_name="fakeimage.jpg",
    ...
    #                      condition="Brand New")
    # db.add_auction_to_db(creatorID=user_1.get('ID'),
    #                      name="Journey's 2.5 minute Auction",
    #                      desc="going, going, gone.",
    #                      image_name="fakeimage.jpg",
    ...
    #                      condition="Brand New")
    # db.add_auction_to_db(creatorID=user_1.get('ID'),
    #                      name="Journey's 3 minute Auction",
    #                      desc="going, going, gone.",
    #                      image_name="fakeimage.jpg",
    #                      end_time=datetime.now(timezone.utc) + timedelta(seconds=240),
    #                      price=500,
    #                      condition="Brand New")
